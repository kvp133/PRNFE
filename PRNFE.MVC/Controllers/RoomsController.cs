...
//            // Nếu có ít nhất 1 điều kiện filter thì gọi API filter
...
//            {
//                TempData["Message"] = "Không thể lấy danh sách phòng từ API.";
//                TempData["IsSuccess"] = false;
...
//            var response = await httpClient.GetAsync($"{_apiQLPTUrl}/api/Rooms/{id}");
//            if (!response.IsSuccessStatusCode)
//            {
//                TempData["Message"] = "Không thể lấy thông tin phòng từ API.";
//                TempData["IsSuccess"] = false;
...
//            // Deserialize theo kiểu ApiResponse<DetailsRoomResponse>
...
//            // Giả sử API yêu cầu truyền buildingId qua query string
//            var response = await httpClient.PostAsync($"{_apiQLPTUrl}/api/Rooms?buildingId={buildingId}", httpContent);

//            if (!response.IsSuccessStatusCode)
//            {
//                var error = await response.Content.ReadAsStringAsync();
//                TempData["Message"] = $"Tạo phòng thất bại: {error}";
//                TempData["IsSuccess"] = false;
//                return View(model);
//            }
...
//            if (!response.IsSuccessStatusCode)
//            {
//                TempData["Message"] = "Không thể lấy thông tin phòng.";
//                TempData["IsSuccess"] = false;
//                return RedirectToAction(nameof(Index));
//            }
...
//            var response = await httpClient.PutAsync($"{_apiQLPTUrl}/api/Rooms/{id}", httpContent);
//            if (!response.IsSuccessStatusCode)
//            {
//                var error = await response.Content.ReadAsStringAsync();
//                TempData["Message"] = $"Cập nhật phòng thất bại: {error}";
//                TempData["IsSuccess"] = false;
//                return View(model);
//            }
